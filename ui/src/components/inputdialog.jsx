...
function InputDialog() {
  ...
  const handlesave = () => {
    if (name == "" || image == "") {
      ...
      nuicallback("save", { name: name, img:image });
      setVisible(false);
    }
  };
      ...
      {visible && (
        <div className="dialog-container">
          ...
          <div className="input-container">
            ...
            <div className="previewinput"  onMouseEnter={() => nuicallback("hover")} onClick={handlepreviewinput}>
              {previewstate ? (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="3vw"
          ...
          <div onClick={handlesave}  onMouseEnter={() => nuicallback("hover")} className="dialog-button">
